...
check_token() {
  ...
  if [ "$USER_TOKEN" = "AzizulAnam" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Token Salah! Beli Kode Token Di BANG SANO${NC}"
    echo -e "${YELLOW}TELEGRAM : @PraiOfficial${NC}"
    echo -e "${YELLOW}CHANEL    : t.me/AnamchanelX${NC}"
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/anamofficial1/Pterodactyl-Installer-Theme/raw/main/stellar.zip")        
        break
        ;;
      2)
        THEME_URL=$(echo -e "https://github.com/anamofficial1/Pterodactyl-Installer-Theme/raw/main/billing.zip")
        break
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/anamofficial1/Pterodactyl-Installer-Theme/raw/main/enigma.zip")
        break
        ;; 
      x)
        return
...
uninstall_theme() {
  ...
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  bash <(curl https://raw.githubusercontent.com/anamofficial1/Pterodactyl-Installer-Theme/main/repair.sh)
  echo -e "                                                       "
  echo -e "${GREEN}[+] =============================================== [+]${NC}"
...
# Unduh file tema
wget -O /root/stellar.zip https://github.com/anamofficial1/Pterodactyl-Installer-Theme/raw/main/stellar.zip
...
while true; do
  ...
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Credit  : Anam Official      ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Telegram  : t.me/PraiOfficial  ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Chanel : t.me/AnamchanelX ${NC}"
